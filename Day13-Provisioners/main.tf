...
resource "aws_key_pair" "example" {
  key_name   = "task"
  public_key = file("C:/Users/ksai3/.ssh/id_rsa.pub")
...
resource "aws_instance" "server" {
  ...
  connection {
    ...
    private_key = file("C:/Users/ksai3/.ssh/id_rsa")
    host        = self.public_ip
    timeout     = "2m"
  }
...
#       "echo 'hello from awsssssss' >> /home/ubuntu/file200"
#     ]
#   }
   provisioner "local-exec" {
    command = "touch file500" 
    # command     = <<EOT
    # echo "This is line 1" > file500.txt        #If we want to add content into the file500
    # echo "This is line 2" >> file500.txt
    # EOT
   interpreter = ["bash", "-c"]
  }
...
#     inline = [
#       "echo 'hello from awsdevops resource' >> /home/ubuntu/file200"
#     ]
#   }
